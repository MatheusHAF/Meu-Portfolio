        ...
        <div id='Home' ref={containerRef} className={styles.container}>
            <nav>
                <p className={styles.ptop}>
                    ...
                    me chamo <a href="https://github.com/MatheusHAF" target="_blank" rel="noreferrer">Matheus</a>
                </p>
                
                <div className={styles.middle}>
                    <p>WEB | Front</p>
                    <p className={styles.picons}>
                        <a href="https://github.com/MatheusHAF" target="_blank" rel="noreferrer"><FaSquareGithub/></a>
                        <a href="https://www.linkedin.com/in/matheus-francisco-a5bb1a218/" target="_blank" rel="noreferrer"><FaLinkedin/></a>
                        <a href="https://docs.google.com/document/d/1KOQpWFTzxla4UvnCnJPs_0ROCjG3KA0e0SXMCnW-IxY/edit?usp=sharing" target="_blank" rel="noreferrer"><FaFileLines/></a>
                    </p>
                </div>
